        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-1">
              {isLogin ? "Sign in to plan your next trip" : "Start planning affordable trips today"}
            </p>
          </div>
          ...
          <div className="bg-card border border-border rounded-2xl p-6 shadow-card">
            ...
            <Button
              variant="outline"
              className="w-full h-12 rounded-xl text-sm font-medium gap-3 mb-6"
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-11 rounded-xl bg-gradient-hero text-primary-foreground font-semibold gap-2"
              >
